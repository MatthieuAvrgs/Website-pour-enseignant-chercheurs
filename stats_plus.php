    ...
    <div id="bodyMiddlePan">
        ...
        if (!empty($_SESSION['connecte'])) {
            ...
            if (isset($_SESSION['nom'])) {
                ...
                echo"<fieldset>";
                echo"<font color='black' size=4><b>Auteur avec le plus grand nombre d'articles</b></font><br/><br/>";
                plus_grand_contributeur($mabase);
...
function plus_grand_contributeur($mabase) {
    //compteur d'auteurs
    ...
    echo("Le(s) auteur(s) ayant écrit le plus d'articles ($nombre_publications_ancien_auteur) sont :<br/><br/>");
    echo("<ul>");
